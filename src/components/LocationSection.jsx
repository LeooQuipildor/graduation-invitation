    ...
    <section className="relative w-full min-h-svh py-10 px-4 flex flex-col items-center justify-center overflow-hidden tablet:py-16 lg:py-12">
      ...
      <div className="relative z-10 w-full max-w-4xl flex flex-col items-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="text-center mb-6 mobile-m:mb-8 mobile-l:mb-8 tablet:mb-12 lg:mb-8"
        >
          <h2 className="font-script text-4xl mobile-m:text-5xl mobile-l:text-5xl tablet:text-6xl lg:text-5xl text-gold-engraved mb-1 drop-shadow-sm">
            Donde celebramos
          </h2>
        ...
        <motion.div
          ...
          className="bg-white w-full max-w-md p-1.5 card-strong-shadow rounded-sm tablet:max-w-xl lg:max-w-lg"
        >
          <div className="border border-gray-400 p-4 mobile-m:p-6 mobile-l:p-6 tablet:p-12 flex flex-col items-center text-center lg:p-8">
            {/* Icono Principal */}
            <div className="text-[#7f8c6c] mb-3 mobile-m:mb-4 mobile-l:mb-4 tablet:mb-6 lg:mb-4">
              <MapPin
                size={40}
                strokeWidth={1.5}
            ...
            {/* Horario */}
            <div className="flex items-center gap-2 text-gold-engraved mb-4 font-serif text-xs mobile-m:text-lg mobile-l:text-lg tablet:text-xl lg:text-lg tablet:mb-8 lg:mb-6">
              <Clock
                size={16}
                  ...
                  <MarkerContent>
                    <div className="text-[#7f8c6c] drop-shadow-md">
                      <MapPin
                        size={32}
                        fill="#7f8c6c"
                        className="text-white tablet:w-10 tablet:h-10 lg:w-8 lg:h-8"
                      />
                    </div>
                  </MarkerContent>
                </MapMarker>
