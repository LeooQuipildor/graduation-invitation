...
const HeroSection = () => {
  return (
    <section className="relative h-svh w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="w-full max-w-4xl mx-auto text-center relative z-10 px-5 mobile-m:px-6">
        <motion.div
        ...
        >
          {/* Texto de Invitación */}
          <p className="font-serif text-[#1e1e1e] text-xs mobile-s:mt-28 mobile-m:text-base md:text-base leading-relaxed tracking-wide mb-2 mobile-m:mb-4 uppercase font-medium mobile-s:px-3 ">
            Acompáñame a celebrar que oficialmente soy contadora pública
          </p>

          {/* Título Profesional */}
          {/* Título Profesional */}
          <h1 className="font-script text-4xl mobile-s:text-3xl mobile-m:text-4xl md:text-6xl lg:text-8xl text-gold-engraved mb-3 mobile-m:mb-4 drop-shadow-sm leading-tight mobile-m:text-5xl">
            Contadora Publica
          </h1>
          ...
          <div className="w-full max-w-[280px] mobile-m:max-w-xs mx-auto mb-6 mobile-m:mb-10">
            <div className="text-center font-serif text-2xl mobile-m:text-4xl text-black mb-1 mobile-m:mb-2">
              Marzo
            </div>
            ...
            <div className="flex items-center justify-between py-0 mobile-m:py-3 w-full">
              ...
              <div className="w-1/3 flex justify-start mobile-s:justify-center">
                <span className="font-serif text-base mobile-m:text-3xl text-black border-t border-b border-black/80 py-1">
                  Sabado
                </span>
              </div>
          ...
          {/* Frase Final */}
          <div className="font-serif text-[#1e1e1e] text-xs mobile-m:text-lg md:text-base italic leading-relaxed max-w-md mx-auto font-medium px-4">
