  ...
  return (
    <section className="relative h-svh w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="w-full max-w-4xl mx-auto text-center relative z-10 px-5 mobile-m:px-6 mobile-l:px-6 tablet:px-10">
        ...
        >
          {/* Texto de Invitación */}
          <p className="font-serif text-[#1e1e1e] text-xs mobile-s:mt-28 mobile-m:text-sm mobile-l:text-base tablet:text-lg md:text-lg leading-relaxed tracking-wide mb-2 mobile-m:mb-4 mobile-l:mb-4 tablet:mb-6 uppercase font-medium mobile-s:px-3">
            Acompáñame a celebrar que oficialmente soy contadora pública
          </p>

          {/* Título Profesional */}
          <h1 className="font-script text-4xl mobile-s:text-3xl mobile-m:text-4xl mobile-l:text-4xl tablet:text-7xl md:text-6xl lg:text-8xl text-gold-engraved mb-3 mobile-m:mb-4 mobile-l:mb-4 tablet:mb-6 drop-shadow-sm leading-tight mobile-l:text-5xl">
            Contadora Publica
          </h1>
          ...
          {/* Nombre */}
          <h2 className="font-script text-3xl mobile-s:text-2xl mobile-s:mb-2 mobile-m:text-3xl mobile-l:text-4xl tablet:text-6xl md:text-5xl lg:text-7xl text-gold-engraved mb-6 mobile-m:mb-10 mobile-l:mb-10 tablet:mb-12 drop-shadow-sm leading-tight px-2">
          ...
          <div className="w-full max-w-[280px] mobile-m:max-w-xs mobile-l:max-w-xs tablet:max-w-md mx-auto mb-6 mobile-m:mb-10 mobile-l:mb-10 tablet:mb-12">
            ...
            <div className="flex items-center justify-between py-0 mobile-m:py-3 mobile-l:py-3 tablet:py-4 w-full">
              ...
              <div className="w-1/3 text-center">
                <span className="font-serif text-5xl mobile-m:text-5xl mobile-l:text-6xl tablet:text-8xl md:text-7xl text-black font-bold leading-none">
                  01
                </span>
              </div>
          ...
          {/* Frase Final */}
          <div className="font-serif text-[#1e1e1e] text-xs mobile-m:text-base mobile-l:text-lg tablet:text-xl md:text-xl italic leading-relaxed max-w-md tablet:max-w-lg mx-auto font-medium px-4">
